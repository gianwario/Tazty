...
<body style="margin-left: 0px; margin-top: 0px; margin-right: 0px; 
	...
	<div id="container">
		<div id="panino_container">
			<div class="panino_pics" id="pane-top-pic"> 
			</div>
			<div class="panino_pics" id="salsa-pic"> 	
			</div>
			<div class="panino_pics" id="add1-pic">
			</div>
			<div class="panino_pics" id="add2-pic">	
			</div>
			<div class="panino_pics" id="carne-pic">
			</div>
			<div class="panino_pics" id="pane-bottom-pic">
			</div>
		</div>
		<div id="selection_container">
			<fieldset style="width: 90%;">
				<legend class="legends">1. Pane</legend>
				 <div class="ingredient_container">
					<select class="ing_select" id="bread-select" onchange="breadChange(this); breadComposer()">
			...
			<fieldset style="width: 90%">
				...
				<div class="ingredient_container">
					<select class="ing_select" id="meat-select" onchange="meatChange(this); meatComposer()">
			...
			<fieldset style="width: 90%">
				...
				<div class="ingredient_container">
					<select class="ing_select" id="add-select1" onchange="addChange(this); add1Composer()">
					...
					<select class="ing_select" id="add-select2" onchange="addChange(this); add2Composer()" style="margin-left: 20px">
						<option value="0" selected>Seleziona</option>
			...
			<fieldset style="width: 90%">
				...
				<div class="ingredient_container">
					<select class="ing_select" id="sauce-select" onchange="sauceChange(this); sauceComposer()">
						<option value="0" selected>Seleziona</option>
	...
	<button id="confirm" onclick="fieldCheck()"> <i class="fa fa-shopping-cart" aria-hidden="true" style="margin-right: 10px;"></i>Aggiungi al carrello</button>
